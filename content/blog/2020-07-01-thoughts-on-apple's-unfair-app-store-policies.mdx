...
When Apple is the biggest company in the world, is this kind of behaviour warranted? Bear in mind that they grossed around about \$50 billion from the App Store in 2019. I highly recommend you have a [quick listen or read through the full podcast](https://www.theverge.com/2020/6/18/21295778/apple-app-store-hey-email-fees-policies-antitrust-wwdc-2020) since it gives you a clear view of how Apple is abusing their position of power. Even though Basecamp's updates to Hey were rejected for not allowing in-app subscription purchases, Netflix managed to circumvent the policy, most likely because Apple doesn't want legal trouble with such a prominent technology company. This leads to another problem where App Store policies are not explicit or equally enforced. Only a few days ago, [developers can challenge guildines given by the App Store](https://www.apple.com/newsroom/2020/06/apple-reveals-new-developer-technologies-to-foster-the-next-generation-of-apps/). This is a step in the right direction but regardless, Apple still has the final word.
